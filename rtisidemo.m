...
% Generates plots to compare estimate and original signal. The last section
...
%% Run this section first to generate an amplitude-only STFT for testing below

clearvars;

filename = 'cello2.wav';                % input filename here
...
%% RTISI Reconstruction

numIts = 2;                             % specify number of synthesis iterations
